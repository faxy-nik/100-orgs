 ...
 * canvas or DOM — BoyRenderer reads currentFrame() from this and draws it.
 */
(function (root) {
  'use strict';
  ...
  function BoyAnimationController(manifest) {
  ...
  BoyAnimationController.prototype._playDefault = function () {
   ...
   */
  BoyAnimationController.prototype.play = function (name, opts) {
    opts = opts || {};
  ...
  BoyAnimationController.prototype.setFlip = function (flipped) {
    this.flipped = flipped;
  };

  /** Advance playback. dtMs = milliseconds since last update. */
  BoyAnimationController.prototype.update = function (dtMs) {
  ...
  BoyAnimationController.prototype.currentFrame = function () {
    if (!this.current) return null;
    return this.current.frames[this.frameIndex];
  };

  BoyAnimationController.prototype.isFinished = function () {
    if (!this.current || this.current.loop) return false;
    return this.frameIndex >= this.current.frames.length - 1 && this.elapsed === 0;
  };

  BoyCompanion.AnimationController = BoyAnimationController;
