...
(function (root) {
  ...
  function BoyInteractions(bus, navigation) {
    this.bus = bus;
  ...
  BoyInteractions.prototype._onCursorMove = function (data) {
  ...
  BoyInteractions.prototype.evaluateProximity = function (companionCenter) {
  ...
  BoyInteractions.prototype._setupReadingObserver = function () {
  ...
  BoyInteractions.prototype._setupSectionObserver = function () {
    if (typeof IntersectionObserver === 'undefined') return;
    var self = this;
